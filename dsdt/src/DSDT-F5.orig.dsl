 ...
 *
 * Disassembly of extract/DSDT.dat, Sat Aug 24 21:09:42 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CC67 (52327)
 *     Revision         0x02
 *     Checksum         0x36
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
        ...
        Scope (\_SB.PCI0)
        {
            ...
            Scope (I2C4)
            {
                ...
                Device (TPEL)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C4.TPEL._CRS.RBUF */
                    }
                ...
                Device (TCS4)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C4.TCS4._CRS.RBUF */
                    }
                    ...
                    OperationRegion (IADR, SystemMemory, 0xD0C407A0, 0x20)
                ...
                Device (KXJ0)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C4.KXJ0._CRS.RBUF */
                    }
            ...
            Scope (I2C5)
            {
                ...
                Device (KXJ1)
                {
                    ...
                    Name (_DDN, "Kionix KXCJ9 Accelerometer Keyboard")  // _DDN: DOS Device Name
                    Name (_UID, 0x02)  // _UID: Unique ID
                    Name (_DEP, Package (0x01)  // _DEP: Dependencies
                    {
                        I2C5
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C5.KXJ1._CRS.RBUF */
                    }
    ...
    OperationRegion (CMO1, SystemIO, 0x72, 0x02)
    Field (CMO1, ByteAcc, NoLock, Preserve)
    {
        IDX1,   8, 
        DTA1,   8
    }
    ...
    Device (_SB.TPM)
    {
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            ...
            Else
            {
                ...
                ElseIf ((TTPF == Zero))
                {
                    CreateDWordField (CRSI, \_SB.TPM._Y0B._BAS, MTFF)  // _BAS: Base Address
                    MTFF = TPMM /* \TPMM */
                    Return (CRSI) /* \_SB_.TPM_.CRSI */
                }
        ...
        Device (H_EC)
        {
            ...
            Device (BAT0)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    If (B1FC)
                    {
                        Local5 = ((B1FC * 0x4C) / 0x0A)
                        Local6 = ((B1DC * 0x4C) / 0x0A)
                        BPKG [0x05] = (Local5 / 0x0A)
                        BPKG [0x06] = (Local5 / 0x19)
                        BPKG [0x07] = (Local6 / 0x64)
                    }
            ...
            {
                SPC0 (0x00C80610, 0x40800102)
            }

            Method (_Q61, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                SPC0 (0x00C80610, 0x40900200)
            }
